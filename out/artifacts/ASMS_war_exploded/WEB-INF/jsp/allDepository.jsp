            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" action="${pageContext.request.contextPath}/addAdmin">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" required="required" name="username" class="form-control" id="adminUsername" placeholder="用户名">
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="col-md-2 col-md-offset-10" hidden>
            <button class="btn btn-info" disabled="disabled" type="button"
                    id="admin_add_modal_btn">新增一项</button>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
